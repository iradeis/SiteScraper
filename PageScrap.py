...
class PageScrap:
    ...
    def __init__(self):
        self.agent = DBAgent("mongodb://59.120.52.19:27017", username='richard', password='nuclear97')
    ...
    def parse_html(self, ASIN):
        ...
        raw_dict = self.agent.ReadProductRaw(ASIN)
        ...
        self.agent.WriteProductInfo(product_info)
